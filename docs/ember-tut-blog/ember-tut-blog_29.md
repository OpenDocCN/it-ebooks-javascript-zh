...
精彩的时刻到了！！先执行[`localhost:4200/articles`](http://localhost:4200/articles)，此时显示的是所有类型的数据。如下图：
...
![result](img/44ef64b644bf20455980d9e6a378c0ae.jpg)
